...
public class WxPayController {
  ...
  public WxPayNotifyResponse parseOrderNotifyResult(@RequestBody String xmlData) throws WxPayException {
    ...
    if ("SUCCESS".equals(result.getResultCode())) {
      checkOrderService.updatePayStatus(result.getOutTradeNo(), "支付成功");
    } else {
      checkOrderService.updatePayStatus(result.getOutTradeNo(), "支付失败");
    }
    WxPayNotifyResponse payNotifyResponse = new WxPayNotifyResponse();
    payNotifyResponse.setReturnCode("SUCCESS");
